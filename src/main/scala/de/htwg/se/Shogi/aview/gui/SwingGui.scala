package de.htwg.se.Shogi.aview.gui
...
import de.htwg.se.Shogi.model.pieceComponent.pieceBaseImpl.PieceFactory
...
class SwingGui(controller: ControllerInterface) extends Frame {
  ...
  val resourcesPath: String = new File(".").getCanonicalPath + "/src/main/scala/de/htwg/se/Shogi/zresources"
